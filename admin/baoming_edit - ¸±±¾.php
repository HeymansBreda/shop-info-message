 ...
 <div class="rt_content">
	  ...
	  <form method="POST" action="baoming_edit.php?sub=yes&id=<?php echo $row['id'];?>" enctype="multipart/form-data">
       ...
       <li>
		...
		<img src="<?php echo "../upimg/".$row['sfz_img']; ?>" width="80" style=" margin-left:120px; margin-top:-30px; ">
        </a>
       </li>
       ...
       <li>
		...
		<img src="<?php echo "../upimg/".$row['cxk_img']; ?>" width="80" style=" margin-left:120px; margin-top:-30px; ">
        </a>
       </li>
       ...
       <li>
		...
		<img src="<?php echo "../upimg/".$row['scsfz_img']; ?>" width="80" style=" margin-left:120px; margin-top:-30px; ">
        </a>
       </li>
