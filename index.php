...
if($_GET['sub'] == 'yes')
{
   ...
   $sql="INSERT INTO `baoming`(`sfz_img` ,`cxk_img` ,`scsfz_img` ,`xingming` ,`sfzhm` ,`jycd` ,`hyzk`,`ysr`,`province3`,`city3`,`area3`,`address`,`zylb`,`tel`,`tjrkh` ,`posttime`) VALUES ('".$fname1."','".$fname2."','".$fname3."','".$xingming."','".$sfzhm."','".$jycd."','".$hyzk."','".$ysr."','".$province3."','".$city3."','".$area3."','".$address."','".$zylb."','".$tel."','".$tjrkh."',now())";
   mysql_query($sql);
   echo "<script language=\"JavaScript\">alert(\"恭喜！您的报名信息提交成功！~\"); window.location.href='search.php';\r\n</script>";
...
<option value="其他">其他</option>
	  ...
	  <p class="ui-identify-procotol"> 
	    <label class="ui-checkbox-s"> 
		  <input type="checkbox" ng-model="agreeFlag" name="danxuan" class="ng-pristine ng-untouched ng-valid" value="1" checked="checked">
		</label>
		同意并签署<a href="#" target="_blank" class="ui-protocol">《小天卡申请服务协议》</a> 
	  </p> 
